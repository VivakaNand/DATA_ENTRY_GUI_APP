...
checkbtn = ttk.Checkbutton(win, text = 'check if you wnat to subscribe our newsletter', variable=checkbtn_var)
...
def action():
    ...
    with open('data.csv', 'a', newline='') as f:
        dict_writer = DictWriter(f, fieldnames=['UserName','UserEmailAddress', 'UserAge', 'UserGender', 'UserType','Subscribed'])
